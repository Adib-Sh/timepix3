...
filename = "/home/adisha/git/libkatherine/build/BeamData 20250608 NanoMAX/thlscan_datadriven_20250608_115511.h5"  # Insert filename here
...
plt.xlabel('Threshold (mV)', fontsize=12)
plt.ylabel('Mean TOT', fontsize=12)
plt.title('Mean Time Over Threshold vs Threshold', fontsize=14)
plt.grid(True, alpha=0.3)
plt.tight_layout()

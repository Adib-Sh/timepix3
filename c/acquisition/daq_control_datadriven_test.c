...
void run_acquisition(katherine_device_t *device, const katherine_config_t *config, arguments_t *args);
...
void initialize_h5_file(arguments_t *args) {
...
int main(int argc, char *argv[]) {
    ...
    run_acquisition(&device, &config, &args);
